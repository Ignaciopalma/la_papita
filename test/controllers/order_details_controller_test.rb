...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { comments: @order_detail.comments, order_id: @order_detail.order_id, product: @order_detail.product, quantity: @order_detail.quantity, sub_total: @order_detail.sub_total }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { comments: @order_detail.comments, order_id: @order_detail.order_id, product: @order_detail.product, quantity: @order_detail.quantity, sub_total: @order_detail.sub_total }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
