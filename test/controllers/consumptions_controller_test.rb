...
class ConsumptionsControllerTest < ActionController::TestCase
  ...
  test "should create consumption" do
    assert_difference('Consumption.count') do
      post :create, consumption: { consumption: @consumption.consumption, product_id: @consumption.product_id, supply_id: @consumption.supply_id }
    end
  ...
  test "should update consumption" do
    patch :update, id: @consumption, consumption: { consumption: @consumption.consumption, product_id: @consumption.product_id, supply_id: @consumption.supply_id }
    assert_redirected_to consumption_path(assigns(:consumption))
  end
